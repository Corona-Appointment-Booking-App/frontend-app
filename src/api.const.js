...
export const API_ENDPOINT_BOOKING_CHECKOUT_FINALIZE =
  "booking/checkout/finalize";

export const API_ERROR_UNEXPECTED_ERROR = "ERROR_UNEXPECTED_ERROR";
export const API_ERROR_VALIDATION = "ERROR_VALIDATION";
export const API_ERROR_BOOKING_EXISTS = "ERROR_BOOKING_EXISTS";
export const API_ERROR_BOOKING_NOT_ALLOWED = "ERROR_BOOKING_NOT_ALLOWED";
